...
const HeaderExtension = ({ open }: HeaderExtensionProps) => {
  return (
          ...
          >
            ...
            >
              <div className="flex flex-col items-center justify-between w-full max-w-64 space-y-5 m-6 gap-3">
                <div className="text-3xl">Join our registration list</div>
                <p className="text-body font-light">
                  And receive updates, expert educational insights, and early
